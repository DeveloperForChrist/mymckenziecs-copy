const TONE_REPLACEMENTS: Array<{ pattern: RegExp; replacement: string }> = [
  ...
  { pattern: /\bi\s+recommend\s+that\s+you\b/gi, replacement: 'one option to consider is to' },
  { pattern: /\bi\s+recommend\b/gi, replacement: 'one option to consider is' },
  { pattern: /\bwe\s+recommend\s+that\s+you\b/gi, replacement: 'one option to consider is to' },
  { pattern: /\bwe\s+recommend\b/gi, replacement: 'one option to consider is' },
  { pattern: /\bit\s+is\s+advisable\s+to\b/gi, replacement: 'it may help to' },

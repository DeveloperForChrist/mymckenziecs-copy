...
const title = 'Case Support Software for UK Legal Support Practices';
const description =
  'See how MyMcKenzieCS helps UK McKenzie Friends, legal support professionals, and the clients they support organise documents, notes, reminders, payments, and research in one workspace.';
...
export const metadata: Metadata = buildPageMetadata({
  title,
  description,
  path: '/uk/legal-case-management-tool',
});
...
export default function LegalCaseManagementToolPage() {
  return (
    <GuidePage
      path="/uk/legal-case-management-tool"
      title={title}
      subtitle="A practical explanation of how UK McKenzie Friends and legal support professionals can manage client matters in one organised workspace."
      meta="Updated 17 March 2026 | UK legal support workflow | Informational only"
      intro={[
      ...
      'This page explains what case support software should actually do for UK McKenzie Friends, legal support professionals, and the clients they support, and how MyMcKenzieCS approaches that problem in a UK court-support context.',
      ]}
      stats={stats}
      sections={sections}
      ...
      primaryCta={{ href: '/uk/organise-court-documents-uk', label: 'Organise documents' }}
      secondaryCta={{ href: '/uk/pricing', label: 'Compare plans' }}
    />
  );
}

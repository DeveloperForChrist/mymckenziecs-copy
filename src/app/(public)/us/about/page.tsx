...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    'Learn why MyMcKenzieCS now has a U.S. version and how the shared workspace supports self-represented litigants with organization and procedural support.',
  path: '/us/about',
});
...
export default function UsAboutPage() {
  return (
    <LegalPageLayout
      ...
      meta="Built by Lenjordan Ltd • Self-representation support in one workspace"
    >
      <div className="space-y-6 text-base md:text-lg">
        <div>
          <h2 className="text-2xl font-semibold mb-2">Why this version exists</h2>
          <p>
            The U.S. version of MyMcKenzieCS exists so self-represented litigants can use the same case-management workflow without feeling like every page was written only for a UK matter.
          </p>
          <p className="mt-3">
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Guides written for self-represented litigants in the United States</li>
        ...
        <div>
          ...
          <p>
            The goal is to make one strong self-help workspace usable across jurisdictions without forcing separate products for every country or court system. The U.S. version is the next step in that rollout.
          </p>
        </div>
      </div>
    </LegalPageLayout>

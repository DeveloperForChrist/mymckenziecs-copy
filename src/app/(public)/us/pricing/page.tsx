...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    'Compare MyMcKenzieCS Basic, Premium, and Premium + plans for U.S. self-represented litigants, including document tools, deadline reminders, and growing U.S. research support.',
  path: '/us/pricing',
});

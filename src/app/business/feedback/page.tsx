...
export default async function BusinessFeedbackPageRoute() {
  ...
  if (!authUser || !isBillingEligibleUser(authUser)) {
    redirect('/auth/signin?redirect=/business/feedback')
  }
  ...
  return <BusinessDashboardClient initialChatPlan={initialAuthPlan} initialActiveId="feedback" />
}

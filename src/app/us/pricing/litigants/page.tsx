...
export const metadata: Metadata = buildPageMetadata({
  title: 'U.S. Litigant Pricing Plans',
  description:
    'Compare MyMcKenzieCS plans for U.S. self-represented litigants who need document organisation, deadline reminders, research support, and case preparation tools.',

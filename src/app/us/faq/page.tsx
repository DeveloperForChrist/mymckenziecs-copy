...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'No. MyMcKenzieCS only handles platform subscription billing. Service invoices, client payments, and collections between professionals and clients happen off-platform.',
  },
] as const;

...
export const metadata: Metadata = buildPageMetadata({
  title: 'Help',
  description:
    'Get MyMcKenzieCS help with account access, billing, document uploads, notes, deadlines, and other day-to-day support questions.',
  path: '/uk/help',
});
    ...
    >
      <div className="space-y-8 text-base md:text-lg">
        <section>
          ...
          <p className="mt-3">
            Visit the <a className="underline" href="/uk/faq">FAQ</a> for common questions, or contact us directly for help.
          </p>
        </section>
        <section>
